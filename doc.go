...
//
// To prevent unauthorized routines from harvesting a cart, method harvest () can not
// be called directly on a cart. This is the reason why harvesting of a cart can only
// be done via the admin panel of the cart.
//
...
// Warning!
//
// When importing this package, import a specific version of the package because the
// master branch of its Github repository (https://github.com/qamarian-dtp/cart) is not
// guaranteed to be always backward compatible with older versions. Don't know how to
// import a specific version, you can read up the http://gopkg.in tool.
package cart
